...
val Pantone448C: Color = Color(PresetColor(0xff4a412a, "Pantone 448 C", "pantone448c"))
/** A named color as per [[https://www.w3.org/TR/css-color-4/ W3C’s list of colors]]. */
...
/** A named color as per [[https://www.w3.org/TR/css-color-4/ W3C’s list of colors]]. */
val RebeccaPurple: Color = Color(PresetColor(0xff663399, "rebecca purple", "rebeccapurple"))
/** A named color as per [[https://www.w3.org/TR/css-color-4/ W3C’s list of colors]]. */
